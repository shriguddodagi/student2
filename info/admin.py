...
from .models import Dept, Class, Student, Attendance, Course, Teacher, Assign, AssignTime, AttendanceClass,startfeed,leave,feedback
...
class feeds(admin.ModelAdmin):
    list_display = ('assocourse', 'teacher', 'suggestions','ratingfield')
    list_per_page = 100


admin.site.register(startfeed)
admin.site.register(leave)
admin.site.register(Attendance)
admin.site.register(feedback,feeds)
