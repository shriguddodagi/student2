...
urlpatterns = [
    ...
    path('student/leave/', views.create_leave, name='leave'),
    path('student/status/', views.app_stats, name="app_stats"),
    path('student/feedback/', views.create_feedback, name='feedback'),
    # path('teacher/pdf',views.GeneratePdf,name='pdf'),
    path('teacher/<int:assign_id>/Report/',views.GeneratePdf,name='pdf'),
]